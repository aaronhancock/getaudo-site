...
EXPLORER_SERVICES = [
    ...
    (
        ...
        "The right person knows what to do without all the copying and reminders.",
    ),
    (
        "Important numbers take too long to see",
        "work",
    ...
    (
        ...
        "The file is important, but it is easy to break, slow, and difficult for everyone to use.",
    ...
    (
        ...
        "I know a few ways AI could save my team time.",
    ),
    (
        "Support replies need to be faster without getting sloppy",
        "ai",
    ...
    (
        "A project has stalled",
        "decisions",
        "My website or software project has stopped",
        "The work started, but now it is stuck and no one is sure what should happen next.",
        "I know why the work stopped and what to do next.",
    ),
    (
        "You have too many product ideas",
        "decisions",
        ...
        "I know what to handle now and what can wait.",
    ),
]
...
EXPLORER_DETAIL_COPY = {
    "Contact form submissions are not arriving": _explorer_detail(
        "People fill out my form, but I never get the message.",
        "I get every message in the right inbox.",
        "I'll test the form and find where the message gets lost.",
        ...
        ("Send a test message.", "Check the form, email, and spam folder.", "Make sure the message arrives where it should."),
        ("Why does the form say it worked when no message arrives?", "Can you fix this without rebuilding my website?", "How will I know the form keeps working?"),
    ),
    "The website feels slow": _explorer_detail(
        "My website takes too long to load.",
        "Pages open quickly, even on a phone.",
        "I'll find what is slowing the site down and fix the biggest problems first.",
        ...
        ("Check the pages customers use most.", "Fix the things causing the biggest delays.", "Test the site again on a phone."),
    ...
    "WordPress warnings are piling up": _explorer_detail(
        "I keep seeing WordPress warnings and do not know what is safe to update.",
        "The warnings are handled, and I know what to do next time.",
        "I'll check the site and backups before I update anything.",
        ...
        ("Check the theme, plugins, and backups.", "Update the safe items first.", "Leave simple notes for the next update."),
    ...
    "The mobile website is confusing": _explorer_detail(
        "My website is frustrating to use on a phone.",
        "Customers can read the page, use the menu, and fill out forms easily.",
        "I'll use the site on a phone and fix the places where people get stuck.",
        ...
        ("Try the main customer task on a phone.", "Fix the menu, forms, and buttons.", "Test the important pages again."),
    ...
    "The homepage no longer matches the business": _explorer_detail(
        "My website still talks about the old version of my business.",
        "The homepage clearly says what I do now.",
        "I'll help rewrite the page around what customers need to know first.",
        ...
        ("Look at what the homepage says today.", "Make the current offer clear.", "Give customers one obvious next step."),
    ...
    "The business needs a better website": _explorer_detail(
        "My website feels old and no longer makes a good first impression.",
        "I have a professional site that explains my business clearly.",
        "I'll keep what still works and rebuild the parts that do not.",
        ...
        ("Look at the pages customers use most.", "Keep the parts that still work.", "Replace the parts that make the site feel old or confusing."),
    ...
    "Leads need follow-up you can trust": _explorer_detail(
        "I worry that new leads are being missed.",
        "Every new lead gets a quick response.",
        "I'll make a simple follow-up process that is easy for the team to use.",
        "Show me what happens after a new lead arrives.",
        "Tell me where leads come from and who should respond to them.",
        "Questions about following up with new leads.",
        ("See what happens when a new lead comes in.", "Decide who should reply and when.", "Make it easy to see who still needs a response."),
    ...
    "Appointment confirmations are confusing": _explorer_detail(
        "Customers are confused after they book.",
        "Customers know when to come, where to go, and how to make a change.",
        "I'll clean up the confirmation and reminder messages.",
        ...
        ("Book a test appointment.", "Add the missing time, location, and change instructions.", "Make sure the reminders arrive at the right time."),
    ...
    "New customer onboarding feels inconsistent": _explorer_detail(
        "Every new customer gets a different start.",
        "Every customer gets the same clear welcome and next steps.",
        "I'll put the forms, payment, files, and welcome messages in a clear order.",
        ...
        ("List what happens after a customer says yes.", "Put the steps in the right order.", "Give the team one clear way to welcome every customer."),
    ...
    "Prospects need quicker quote or fit answers": _explorer_detail(
        "Customers have to wait too long for a price or answer.",
        "Customers get a useful answer sooner.",
        "I'll make it easier to collect the right details and reply quickly.",
        ...
        ("Ask for the details that change the answer.", "Give a clear price, range, or next step.", "Send unusual questions to the right person."),
    ...
    "Give customers a cleaner way to send requests and files": _explorer_detail(
        "Customer requests and files are spread across email, text, and other places.",
        "Customers have one clear place to send what I need.",
        "I'll set up one simple way to send requests and files.",
        ...
        ("List what customers usually send.", "Create one simple form or page for it.", "Let the right person know when something arrives."),
    ...
    "Customer details are disconnected from the CRM": _explorer_detail(
        "I have to look in several places to understand what happened with a customer.",
        "I can find the whole customer story in one place.",
        "I'll bring the customer details your team needs into one place.",
        ...
        ("Find where the important customer details live.", "Choose one place to keep the latest information.", "Bring in new details without making extra copies."),
    ...
    "Turn form submissions into tracked tasks": _explorer_detail(
        "I have to copy every form into a task by hand.",
        "Each form turns into a clear task for the right person.",
        "I'll connect the form to the way your team already works.",
        "Show me what happens after someone submits the form.",
        "Send the form and tell me what should happen after someone fills it out.",
        "Questions about turning forms into assigned work.",
        ("Look at what happens after a form comes in.", "Use the form answers to create the task.", "Send the task to the right person."),
    ...
    "Important numbers take too long to see": _explorer_detail(
        "It takes too long to pull the numbers together.",
        "I can see the numbers I need without rebuilding the report.",
        "I'll help choose the few numbers that matter and put them in one simple view.",
        "Show me the report you keep rebuilding.",
        "Tell me which numbers you look at and where you find them now.",
        "Questions about simpler business reporting.",
        ("List the numbers you check most often.", "Find where each number comes from.", "Put them together in one easy report."),
        ("Which numbers should I keep an eye on?", "Can the report update without me rebuilding a spreadsheet?", "How will we know if a number is wrong?"),
    ),
    "Proposals take too long to prepare": _explorer_detail(
        "I keep rewriting the same proposal.",
        "I can make a good proposal faster.",
        "I'll turn the parts you use every time into a simple template.",
        "Show me how you build a proposal now.",
        "Send a recent proposal and tell me which parts you rewrite every time.",
        "Questions about preparing proposals faster.",
        ("Mark what stays the same in every proposal.", "Make the prices and choices easy to update.", "Keep a final check before anything is sent."),
    ...
    "CRM data is hard to trust": _explorer_detail(
        "I do not trust the customer list because details are missing or repeated.",
        "My team has one clean customer list.",
        "I'll clean up the list and make it harder for the same problems to return.",
        "Show me where the customer list breaks down.",
        "Tell me what is wrong with the customer list and what your team needs from it.",
        "Questions about cleaning up customer records.",
        ("Find repeated and missing customer records.", "Keep only the details your team actually uses.", "Make new records easier to enter correctly."),
        ("How do you know which repeated customer record is right?", "Can we clean the list without losing history?", "How do we stop the same problems from returning?"),
    ),
    "A spreadsheet is carrying too much responsibility": _explorer_detail(
        "Too much of the business depends on one complicated spreadsheet.",
        "The work is easier to use and less likely to break.",
        "I'll keep what is useful and replace the parts that cause trouble.",
        "Show me the spreadsheet everyone depends on.",
        "Tell me what the spreadsheet does and what keeps going wrong.",
        "Questions about replacing an overworked spreadsheet.",
        ("See how the team uses the spreadsheet.", "Keep the parts that save time.", "Move the work into something easier to share and use."),
        ("Does a complicated spreadsheet always need custom software?", "Can I keep the information already in the spreadsheet?", "Will the replacement be easier for the team to use?"),
    ),
    "Copy-paste is slowing the work down": _explorer_detail(
        "We type the same information into more than one app.",
        "The information moves where it needs to go.",
        "I'll connect the repeated steps that are worth saving time on.",
        "Show me what your team keeps copying.",
        "Tell me what you copy, where it comes from, and where it needs to go.",
        "Questions about reducing copy-and-paste work.",
        ("Watch one copy-and-paste job from start to finish.", "Match the information in both apps.", "Make sure missing details do not get lost."),
        ("Which copy-and-paste jobs are worth fixing first?", "Can the apps we already use share information?", "What happens when the information does not match?"),
    ),
    "There are too many AI tools to choose from": _explorer_detail(
        "I do not know which AI tools are worth paying for.",
        "I know which tools are useful for my business.",
        "We'll start with the work you want help with, not a list of tools.",
        "Tell me what you hope AI will help you do.",
        "Tell me what work you want AI to make easier.",
        "Questions about choosing useful AI tools.",
        ("Pick one job that takes too much time.", "Try a few tools on that same job.", "Keep only the tool that actually helps."),
        ("How do I compare AI tools that all promise the same thing?", "Should we pay for a tool before the team tests it?", "How will I know if an AI tool is really saving time?"),
    ),
    "The team needs safer rules for AI and client data": _explorer_detail(
        "My team is using AI, but we do not have clear rules.",
        "Everyone knows what is safe to share and what needs a person to check.",
        "I'll help write simple rules your team can actually follow.",
        "Tell me how your team is using AI today.",
        "Tell me which AI tools your team uses and what information they work with.",
        "Questions about safer AI use at work.",
        ("List how the team is using AI now.", "Decide what information should never be shared.", "Write down when a person needs to check the work."),
        ("What information should never be pasted into an AI tool?", "Do different AI tools need different rules?", "How do we make the rules simple enough to use every day?"),
    ),
    "The team does not know where AI fits": _explorer_detail(
        "I keep hearing about AI, but I do not know where it would help.",
        "I have a few useful ways to save time with AI.",
        "We'll look at the work your team repeats and start with one simple test.",
        "Show me the work your team repeats.",
        "Tell me which tasks your team repeats or keeps putting off.",
        "Questions about using AI for everyday work.",
        ("List the work your team repeats every week.", "Try AI on one simple task.", "Keep what helps and stop what does not."),
        ("What are some good first uses of AI for a small business?", "What work should AI not handle?", "How much time should AI save before it is worth using?"),
    ),
    "Support replies need to be faster without getting sloppy": _explorer_detail(
        "My team spends too much time writing the same kinds of replies.",
        "Replies are faster, accurate, and still sound like us.",
        "I'll help AI draft replies using information you trust.",
        ...
        ("Collect the questions customers ask most often.", "Show AI the right answers and examples.", "Have a person check every reply before it is sent."),
        ("Will the replies sound like a real person?", "How do we stop AI from giving the wrong answer?", "Can the team stay in control of every message?"),
    ),
    "Procedures are hard for the team to find": _explorer_detail(
        "My team knows the instructions exist but cannot find them.",
        "People can find the answer without searching through old files and messages.",
        "I'll bring the instructions together and make them easy to search.",
        "Show me where your instructions are stored.",
        "Tell me what people search for most and where those instructions are kept now.",
        "Questions about making procedures easier to find.",
        ("Gather the files and notes people use.", "Remove old or wrong instructions.", "Make the current answers easy to find."),
        ("Do we have to rewrite every instruction first?", "How will it know which instructions are current?", "Can people see where the answer came from?"),
    ),
    "Website visitors need quick answers": _explorer_detail(
        "Customers keep calling or emailing with the same simple questions.",
        "Customers get quick answers and know when to contact a person.",
        "I'll start with the questions you answer most often.",
        ...
        ("Choose the questions that have simple answers.", "Use the answers your business already gives.", "Send harder questions to a person."),
        ("Which website questions should get an instant answer?", "How do we stop it from making up an answer?", "When should a person take over?"),
    ),
    "Set up the basics for a new small business": _explorer_detail(
        "There are a lot of things to set up, and I do not know where to start.",
        "Everything works together and is easy to use.",
        "We'll set up only what your business needs right now.",
        "Tell me what your new business needs to do.",
        "What kind of business are you starting, and what do you need help setting up?",
        "Questions about setting up your business technology.",
        ("Make a list of what the business needs to do.", "Pick simple tools that fit.", "Connect everything and show you how it works."),
        ("What should I set up before I open?", "Do I need separate tools for email, booking, and payments?", "Can I add more later without starting over?"),
    ),
    "A build-vs-buy decision is unclear": _explorer_detail(
        "The software I found is close, but none of it feels quite right.",
        "I know whether buying or building makes more sense.",
        "We'll compare the choices in plain English before you spend money.",
        "Tell me what the software needs to do.",
        "Tell me which tools you looked at and what they are missing.",
        "Questions about buying software or building it.",
        ("List what the tool absolutely needs to do.", "Compare the real cost of buying and building.", "Try the simplest choice before making a big commitment."),
        ("How close does ready-made software need to be?", "What costs are easy to miss when something is built for me?", "Can we test the idea before I spend a lot of money?"),
    ),
    "Simplify the process before you buy or build software": _explorer_detail(
        "The way we do the work may be the real problem.",
        "The work is simpler before I buy another tool.",
        "I'll walk through the steps with you and remove the ones that do not help.",
        "Walk me through the work that feels broken.",
        "Walk me through one job that feels slow or confusing.",
        "Questions about fixing the process before the software.",
        ("Follow one real job from start to finish.", "Remove steps that waste time.", "Decide if new software is still needed."),
        ("How do we know if the problem is the process or the software?", "Can we simplify the work without disrupting the team?", "What if the best answer is not buying another tool?"),
    ),
    "A vendor proposal is hard to evaluate": _explorer_detail(
        "I got a proposal, but I cannot tell if it is a good deal.",
        "I understand what I am paying for and what may be missing.",
        "I'll explain the proposal in plain English and help you ask the right questions.",
        ...
        ("Match each promised item to something the business needs.", "Look for extra costs and missing work.", "Write down the questions to ask before signing."),
        ("What parts of a technology proposal should I look at closely?", "How do I compare two very different proposals?", "Can you join a vendor conversation if questions remain?"),
    ),
    "A project has stalled": _explorer_detail(
        "My project has stopped, and I am not sure how to get it moving.",
        "I know what is stuck and what needs to happen next.",
        "I'll help find the problem and choose a small next step.",
        "Tell me where the project stopped.",
        "Tell me what was finished, where things stopped, and who is still involved.",
        "Questions about recovering a stalled project.",
        ("Look at what has already been done.", "Find the decision or problem holding things up.", "Restart with one small piece of work."),
        ("Can we save the work that is already done?", "What if the original developer or vendor is unavailable?", "How do we keep the project moving this time?"),
    ),
    "You have too many product ideas": _explorer_detail(
        "I have too many technology problems and do not know which one to fix first.",
        "I have a clear list of what to do now and what can wait.",
        "We'll sort the list by what matters most to the business.",
        "Show me the list that keeps growing.",
        "Tell me which problems and ideas are all competing for attention.",
        "Questions about deciding what to do first.",
        ("Put similar problems together.", "Choose what is hurting the business most.", "Start with one job that has a clear ending."),
        ("How do I compare an urgent fix with a new idea?", "Should I start with the easiest fix or the most important one?", "How often should I look at the list again?"),
    ),
}


EXPLORER_FAQ_ANSWERS = {
    "Contact form submissions are not arriving": (
        "The page can show a success message even when the email fails later. I can test each step and find where it stops.",
        "Usually, yes. Most form problems can be fixed without replacing the website.",
        "I'll leave you with a simple test and show you where to check for new messages.",
    ),
    "The website feels slow": (
        "Large pictures, too many add-ons, or slow website hosting are common causes. I'll check before recommending a fix.",
        "Usually not. I start with the current site and fix the biggest slowdowns first.",
        "It depends on what is causing the delay, but we can test the main pages before and after each fix.",
    ),
    "WordPress warnings are piling up": (
        "Some warnings are simple reminders. Others can affect security or break a feature, so I'll sort them before changing anything.",
        "It can, which is why I check backups and the important parts of the site before updating.",
        "Yes. I can remove what you no longer need and leave a short, clear update routine.",
    ),
    "The mobile website is confusing": (
        "A page can fit a large screen but still have tiny buttons, crowded menus, or forms that are hard to use on a phone.",
        "I start with the things customers need most, such as the menu, contact button, booking, and forms.",
        "Usually, yes. Many phone problems can be fixed on the site you already have.",
    ),
    "The homepage no longer matches the business": (
        "If people ask questions the homepage should answer, or contact you for the wrong thing, the message probably needs work.",
        "Not always. We can start with the homepage and update other pages only if they also need it.",
        "They should quickly understand what you do, who you help, and what to do next.",
    ),
    "The business needs a better website": (
        "If the site still works but looks dated, a refresh may be enough. If it is hard to update or no longer fits the business, rebuilding may make more sense.",
        "It needs a clear message, easy contact options, useful pages, and a good experience on phones.",
        "Yes. I can build it so common changes do not require a developer.",
    ),
    "Leads need follow-up you can trust": (
        "Leads are often missed in a busy inbox, during a handoff, or when no one knows who should reply.",
        "Yes. A shared list, clear owner, and a few reminders may be enough.",
        "They'll be able to see who replied, who owns the lead, and who is still waiting.",
    ),
    "Appointment confirmations are confusing": (
        "Include the date, time, location or meeting link, what to bring, and how to cancel or change the appointment.",
        "Yes. One booking can send the confirmation and later reminders.",
        "I can add a clear change or cancel link to the message.",
    ),
    "New customer onboarding feels inconsistent": (
        "They should receive a welcome, know what you need from them, and understand the next step.",
        "The repeated reminders and paperwork can be automatic. Personal conversations and important checks should stay personal.",
        "Yes. A short checklist or welcome page can show what is done and what is left.",
    ),
    "Prospects need quicker quote or fit answers": (
        "Yes. You can give a price range, explain the choices, or say whether the job sounds like a fit.",
        "Ask only for the details that change the answer. I can help you find that short list.",
        "Use your real prices and rules, and send unusual requests to a person for review.",
    ),
    "Give customers a cleaner way to send requests and files": (
        "Only if it makes things easier for them. A simple form or upload page may be all you need.",
        "I can use a protected upload and make sure only the right people can open the files.",
        "Yes. They can see a confirmation and receive a clear next step.",
    ),
    "Customer details are disconnected from the CRM": (
        "Probably not. I'll first see whether your current system can hold the information your team needs.",
        "Keep the details people need to serve the customer and follow up. Leave out information no one uses.",
        "We can match people by details such as email or phone number before adding a new record.",
    ),
    "Turn form submissions into tracked tasks": (
        "Often, yes. Many common forms and task apps can work together.",
        "The form can use a simple choice, such as service, location, or customer type, to send the task to the right person.",
        "We can flag it for review and ask for the missing details instead of letting it disappear.",
    ),
    "Important numbers take too long to see": (
        "Start with the numbers that change a decision, such as sales, new leads, booked work, or unpaid bills.",
        "Usually, yes. I can connect the places where the numbers already live.",
        "We'll make it easy to check the total against the original source and notice when something looks wrong.",
    ),
    "Proposals take too long to prepare": (
        "Yes. The repeated sections can stay consistent while the customer's needs and your recommendation stay personal.",
        "They should come from one current list so old prices or wording do not slip into a proposal.",
        "Yes. Nothing needs to be sent until you have checked and approved it.",
    ),
    "CRM data is hard to trust": (
        "We'll compare the details, dates, and recent activity before choosing which record to keep.",
        "Yes. We can keep useful notes and past activity while cleaning up repeated records.",
        "We'll make new entries easier and add checks for the mistakes that happen most often.",
    ),
    "A spreadsheet is carrying too much responsibility": (
        "No. Sometimes cleaning up the sheet or splitting it into simpler parts is enough.",
        "Yes. We can move the existing information instead of making everyone start over.",
        "That is the goal. I'll design it around the people who use it every day.",
    ),
    "Copy-paste is slowing the work down": (
        "Start with jobs that happen often, take time, and cause mistakes when someone is rushed.",
        "Often, yes. I'll check the apps you already pay for before suggesting anything new.",
        "We can stop the move, flag the problem, and ask a person to fix it instead of guessing.",
    ),
    "There are too many AI tools to choose from": (
        "Give each tool the same real job and compare the result, time saved, price, and ease of use.",
        "Not if a free trial is available. It is better to test with real work before committing.",
        "Track how long the job takes before and after, including the time needed to check and fix the answer.",
    ),
    "The team needs safer rules for AI and client data": (
        "Do not share passwords, private customer details, payment information, health information, or anything you would not want outside the business.",
        "Yes. What is safe can change depending on the tool, its settings, and how it uses what you enter.",
        "Keep the rules short, use real examples, and put them where people already work.",
    ),
    "The team does not know where AI fits": (
        "Drafting a first version, summarizing notes, organizing ideas, and rewriting plain text are good places to start.",
        "AI should not make final decisions about money, people, safety, or private customer matters without a person checking.",
        "It should save enough time to cover the cost and the time spent checking its work.",
    ),
    "Support replies need to be faster without getting sloppy": (
        "They can. I'll use examples of replies that already sound like your business.",
        "Give it only trusted answers, tell it when not to answer, and have a person check the message before sending.",
        "Yes. Your team can edit, approve, or reject every draft.",
    ),
    "Procedures are hard for the team to find": (
        "No. We can start with the instructions people need most and clean up the rest over time.",
        "We'll mark the current version and remove or clearly label old instructions.",
        "Yes. Each answer can point back to the file or page it came from.",
    ),
    "Website visitors need quick answers": (
        "Start with common questions that have one clear answer, such as hours, location, services, and booking.",
        "Use only answers you have provided, and tell it to ask a person when the answer is not clear.",
        "A person should take over for complaints, unusual requests, private information, or anything involving a promise or price exception.",
    ),
    "Set up the basics for a new small business": (
        "Most businesses need a domain, email, a simple website, a way to get paid, and a way for customers to contact or book them.",
        "Sometimes one service can handle more than one job. I'll help you avoid paying for extra tools you do not need.",
        "Yes. We'll choose a simple setup that can grow one piece at a time.",
    ),
    "A build-vs-buy decision is unclear": (
        "It should handle the parts that matter most without forcing your team into a bad way of working.",
        "Updates, fixes, hosting, support, and future changes can cost more than the first build.",
        "Yes. We can try a simple version or a short test before you commit.",
    ),
    "Simplify the process before you buy or build software": (
        "If people skip steps, keep their own notes, or repeat the same work, the process may need attention first.",
        "Yes. We can change one part at a time and keep the current work moving.",
        "That may be the best result. The goal is to make the work easier, not to add another tool.",
    ),
    "A vendor proposal is hard to evaluate": (
        "Look closely at what is included, what is not, what happens after launch, and what could cost extra.",
        "I'll put both into the same simple list so you can compare the price, work, timing, and support.",
        "Yes. I can help you prepare for the call or join it with you.",
    ),
    "A project has stalled": (
        "Often, yes. I'll review what works, what is unfinished, and what can still be used.",
        "We can gather the files, logins, notes, and current work, then decide what another person needs to continue.",
        "We'll choose one owner, one clear next step, and short check-ins so problems show up early.",
    ),
    "You have too many product ideas": (
        "First fix anything that is costing customers, money, or time today. Then compare the new idea with what is left.",
        "Start with the most important fix that you can finish without creating a much bigger problem.",
        "Review it when the business changes, new information arrives, or the current top item is finished.",
    ),
}
